...
void NodeGraphPrivate::pasteNodesInternal(const NodeClipBoard &clipboard,
...
void NodeGraphPrivate::restoreConnections(const std::list<NodeSerializationPtr> &serializations,
...
void NodeGraphPrivate::getNodeSet(const NodesGuiList &nodeList, std::set<NodeGuiPtr> &nodeSet)
{
