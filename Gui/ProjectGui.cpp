...
ProjectGui::ProjectGui(Gui *gui)
    : _gui(gui), _project(), _panel(NULL), _created(false), _colorPickersEnabled()
{
}
...
template <>
void ProjectGui::save<boost::archive::xml_oarchive>(boost::archive::xml_oarchive &archive) const
{
...
template <>
void ProjectGui::load<boost::archive::xml_iarchive>(bool isAutosave, boost::archive::xml_iarchive &archive)
{
...
void ProjectGui::clearColorPickers()
{
...
void ProjectGui::registerNewColorPicker(KnobColorPtr knob)
{
    clearColorPickers();
    _colorPickersEnabled.push_back(knob);
}

void ProjectGui::removeColorPicker(KnobColorPtr knob)
{
...
void ProjectGui::setPickersColor(double r,
                                 double g,
                                 double b,
                                 double a)
{
